...
#Region "Get Challan Details For List Screen"
    ...
    'Modified-by MUKESH BHAGAT on 18-09-2026 : VendorChallanList now searches by a From Date - To Date
    'calendar instead of Process Year / Process Month. Same as GetChallanDetails_Vr2 except the two
    'period parameters, and it calls the new _vr5 SP (identical output columns to _vr4, filtered on the
    'challan date shown in the grid; both dates inclusive). _Vr2 / _vr4 are left untouched as rollback.
    Public Function GetChallanDetails_Vr3(ByVal Unit As String, ByVal Depot As String, ByVal FromDate As Date, ByVal ToDate As Date, ByVal ChalanNo As Integer, ByVal status As String, ByVal UserId As String, ByVal DespatchType As String) As DataSet
        Dim UnitDS As New DataSet
        Dim sqlParams(7) As SqlParameter
        ...
        UnitDS = DBFactory.GetHelper().ExecuteDataSet("[Unit_Dspatch_Get_Challan_Detail_vr5]", Data.CommandType.StoredProcedure, sqlParams)
        Return UnitDS
    End Function
